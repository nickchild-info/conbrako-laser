...
class PageDispatcher extends import_dispatcher.Dispatcher {
  ...
  async agentPerform(params, progress) {
    return await (0, import_pageAgent.pageAgentPerformWithEvents)(progress, this._page, params);
  }
  async agentExpect(params, progress) {
    return await (0, import_pageAgent.pageAgentExpectWithEvents)(progress, this._page, params);
  }
  async agentExtract(params, progress) {
    return await (0, import_pageAgent.pageAgentExtractWithEvents)(progress, this._page, params);
  }
